...
const AIAssistantWidget = () => {
  const [messages, setMessages] = useState([
    { sender: "bot", text: "Hi! I'm your KodiSmart AI assistant. Ask me anything about rent, tenants, payments, or maintenance." },
  ]);
  ...
  return (
    <div className="bg-card border border-border rounded-2xl shadow-card p-6 max-w-md mx-auto mb-8">
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-lg font-semibold text-foreground">KodiSmart AI Assistant</span>
      </div>
