...
const SettingsTab = () => {
  ...
  const [profile, setProfile] = useState({ name: "Frank Kipchoge", email: "frank@kodismart.com" });
  const [property, setProperty] = useState({ name: "KodiSmart Apartments", address: "123 Main St, Nairobi" });
