...
const mockRooms = [
  { id: "1A", status: "Occupied", tenant: { name: "Alice Kipchoge", email: "alice@kodismart.com", phone: "+254700000001" } },
  { id: "1B", status: "Vacant", tenant: null },
  { id: "2A", status: "Occupied", tenant: { name: "Bob Kamau", email: "bob@kodismart.com", phone: "+254700000002" } },
  { id: "2B", status: "Occupied", tenant: { name: "Carol Kipchoge", email: "carol@kodismart.com", phone: "+254700000003" } },
  { id: "3A", status: "Vacant", tenant: null },
  { id: "3B", status: "Occupied", tenant: { name: "Emma Kipchoge", email: "emma@kodismart.com", phone: "+254700000004" } },
  { id: "4A", status: "Occupied", tenant: { name: "Frank Kipchoge", email: "frank@kodismart.com", phone: "+254700000005" } },
];
